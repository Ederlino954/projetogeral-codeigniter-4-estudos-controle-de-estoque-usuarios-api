        ...
        <form action="<?php site_url('users/admin_new_user') ?>" method="post">
            ...
            <div class="row">
                ...
                <div class="col-6 form-group text-center">
                    <button type="button" class="btn btn-primary btn-150" id="btn-password">Gerar password</button> <!-- ação no App.js em Assets -->
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6 form-group text-center">
                    <button type="button" class="btn btn-secondary btn-150" id="btn-limpar">Limpar</button>  <!-- ação no App.js em Assets -->
                </div>
            </div>
