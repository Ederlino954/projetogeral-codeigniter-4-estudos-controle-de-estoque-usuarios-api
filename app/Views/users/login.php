...
?>
<?php $this->section('conteudo') ?> <!-- renderizando conteúdo  -->

<?php echo view('users/userbar') ?> <!-- Apresenta a informação de login   -->
...
<div class="row mt-3 mb-3">
    <div class="col-4 offset-4 card bg-light">            
        ...
        <!-- Error está no login do user em controller // preeenchimento dos campos  -->
        <?php if(isset($error)): ?>
...
<?php $this->endSection() ?> <!-- fechando renderização  -->