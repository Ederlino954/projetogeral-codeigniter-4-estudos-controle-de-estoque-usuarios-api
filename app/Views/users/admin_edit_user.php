...
<?php $this->section('conteudo') ?>
    ...
    <div class="row mt-3 mb-3">
        ...
        <!-- erro  sendo recebido do controller -->
        <?php if(isset($error)):?>
        ...
        <form action="<?php site_url('users/admin_edit_user') ?>" method="post">
            <input type="hidden" name="id_user" value="<?php echo $user['id_user'] ?>">  <!-- id do utilizador  -->

            <div class="form-group">
                Username: <b><?php echo $user['username'] ?></b> <!-- evitar editar username para questão de acesso do proprietário  -->
            </div>
